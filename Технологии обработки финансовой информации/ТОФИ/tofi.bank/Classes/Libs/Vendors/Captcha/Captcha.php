...
$width=122; /* ширина картинки */
$height=25; /* высота картинки */
$font_size_min=12; /* минимальная высота символа */
$font_size_max=16; /* максимальная высота символа */
$font_file = LIBS . 'Vendors/Captcha/Comic_Sans_MS.ttf'; /* путь к файлу относительно w3captcha.php */
...
$char_align=18;	/* выравнивание символа по-вертикали */
$start=25;	/* позиция первого символа по-горизонтали */
...
$background_color=imagecolorallocate($image, 208, 208, 208); /* rbg-цвет фона */
